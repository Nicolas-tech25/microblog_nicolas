...
<article class="p-5 my-4 rounded-3 bg-white shadow">
    <div class="container-fluid py-1">        
        <h2 class="display-4">Olá <b class="text-primary"><?=$_SESSION["nome"]?></b>!</h2>
		...
		site Microblog e seu <b>nível de acesso</b> é <span class="badge bg-primary"> <?=$_SESSION["tipo"]?> </span>.</p>
        <hr class="my-4">
